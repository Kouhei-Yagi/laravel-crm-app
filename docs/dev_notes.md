...
### ブランチ名：**refactor/search-customers**
...
### ブランチ名：**refactor/search-customers-extended**
...
### ブランチ名：**refactor/search-projects**
...
### ブランチ名：**refactor/search-interactions**
...
### ブランチ名：**refactor/filter-customers**
...
### ブランチ名：**refactor/filter-projects**
...
- 税抜金額では`whereBetween`を活用してリファクタリングすることを要検討
